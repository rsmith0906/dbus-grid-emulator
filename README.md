...
Integrate Tesla API data for a car charging data into Victron Energies Venus OS

## Purpose
With the scripts in this repo it should be easy possible to install, uninstall, restart a service that connects the Tesla API for a specific car to the VenusOS and GX devices from Victron.
